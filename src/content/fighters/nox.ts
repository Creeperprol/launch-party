...
/** NOX — lantern specter. Three midair jumps, drifting wisps, phase-through dash, lantern slam. */
const rig: Rig = {
...
const lantern = (g: number, from: number, to: number, dmg: number, angle: number, kbg: number): MoveDef['hitboxes'][number] =>
  ({ g, from, to, at: 'handF', off: [0, -12], r: 18, dmg, angle, bkb: 30, kbg, sfx: 'fire', fx: 'fire' });
...
const moves: Record<string, MoveDef> = {
  ...
  ftilt: {
    id: 'ftilt', total: 26,
    hitboxes: [lantern(0, 8, 11, 9, 36, 80)],
    anim: [{ f: 4, hF: [-16, 70], lean: -8 }, { f: 8, hF: [56, 60], lean: 14 }, { f: 11, hF: [54, 56], lean: 14 }],
  },
  utilt: {
    id: 'utilt', total: 26,
    hitboxes: [lantern(0, 7, 12, 8, 90, 82)],
    anim: [{ f: 3, hF: [40, 50] }, { f: 7, hF: [30, 100] }, { f: 12, hF: [-20, 100], lean: -10 }],
  },
  dtilt: {
    id: 'dtilt', total: 20,
    hitboxes: [{ g: 0, from: 5, to: 8, pos: [40, 6], r: 18, dmg: 6, angle: 30, bkb: 30, kbg: 60, sfx: 'fire', fx: 'fire' }],
  ...
  fsmash: {
    id: 'fsmash', total: 50, charge: { frame: 12, smash: true },
    hitboxes: [{ ...lantern(0, 15, 18, 17, 36, 94), r: 26 }],
    anim: [{ f: 6, hF: [-30, 90], lean: -16 }, { f: 12, hF: [-30, 90], lean: -16 }, { f: 15, hF: [60, 56], lean: 22 }, { f: 19, hF: [58, 40], lean: 24 }],
  },
  usmash: {
    id: 'usmash', total: 46, charge: { frame: 9, smash: true },
    hitboxes: [{ ...lantern(0, 11, 16, 15, 90, 90), r: 26 }],
    anim: [{ f: 9, hF: [40, 30], lean: 10 }, { f: 11, hF: [30, 110] }, { f: 16, hF: [-30, 110], lean: -10 }],
  },
  dsmash: {
    id: 'dsmash', total: 46, charge: { frame: 8, smash: true },
    hitboxes: [
      { g: 0, from: 11, to: 14, pos: [50, 10], r: 24, dmg: 13, angle: 28, bkb: 32, kbg: 86, away: true, sfx: 'fire', fx: 'fire' },
      { g: 0, from: 11, to: 14, pos: [-50, 10], r: 24, dmg: 13, angle: 28, bkb: 32, kbg: 86, away: true, sfx: 'fire', fx: 'fire' },
    ],
  ...
  nair: {
    ...
    hitboxes: [{ g: 0, from: 5, to: 20, at: 'center', r: 30, dmg: 7, angle: 45, bkb: 18, kbg: 76, sfx: 'fire', fx: 'fire' }],
    anim: [{ f: 3, spin: 0 }, { f: 20, spin: 720 }],
  },
  fair: {
    id: 'fair', total: 34, air: true, landingLag: 9,
    hitboxes: [lantern(0, 8, 11, 10, 40, 84)],
    anim: [{ f: 4, hF: [0, 100], lean: -8 }, { f: 8, hF: [56, 50], lean: 14 }, { f: 11, hF: [50, 30], lean: 16 }],
  },
  bair: {
  ...
  uair: {
    ...
    hitboxes: [lantern(0, 6, 11, 9, 88, 80)],
    anim: [{ f: 3, hF: [40, 60] }, { f: 6, hF: [20, 104] }, { f: 11, hF: [-30, 96] }],
  },
  dair: {
    id: 'dair', total: 40, air: true, landingLag: 16,
    hitboxes: [lantern(0, 11, 15, 12, 270, 72)],
    anim: [{ f: 5, hF: [40, 110] }, { f: 11, hF: [20, -10], lean: 10 }, { f: 15, hF: [16, -12] }],
  },
  nspecial: {
    id: 'nspecial', total: 40, iasa: 30,
    projectiles: [{
      frame: 13, kind: 'wisp', at: 'handF', vx: 6.5, vy: -0.4, gravity: 0.006, life: 100, r: 14, reflectable: true,
      hit: { dmg: 8, angle: 50, bkb: 30, kbg: 52, sfx: 'fire' },
    }],
    hitboxes: [],
  ...
  sspecial: {
    ...
    hitboxes: [{ g: 0, from: 20, to: 23, at: 'center', r: 34, dmg: 9, angle: 50, bkb: 44, kbg: 60, sfx: 'fire', fx: 'fire' }],
  ...
  uspecial: {
    ...
    hitboxes: [{ g: 0, from: 5, to: 9, at: 'center', r: 30, dmg: 6, angle: 80, bkb: 40, kbg: 50, sfx: 'fire', fx: 'fire' }],
  ...
  dspecial: {
    ...
    hitboxes: [
      { ...lantern(0, 20, 23, 16, 70, 82), r: 30 },
      { g: 0, from: 20, to: 23, pos: [70, 10], r: 30, dmg: 12, angle: 70, bkb: 40, kbg: 76, sfx: 'fire', fx: 'fire' },
    ],
    anim: [{ f: 10, hF: [-10, 130], lean: -16 }, { f: 18, hF: [-10, 130], lean: -16 }, { f: 20, hF: [60, 20], lean: 30 }, { f: 30, hF: [60, 16], lean: 30 }],
  },
};
