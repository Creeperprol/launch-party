...
/** KOI — tide dancer. Slow floating bubbles, a long water whip, geyser recovery, splash reflector. */
const rig: Rig = {
...
const whip = (from: number, to: number, x: number, y: number, dmg: number, angle: number): MoveDef['hitboxes'][number] =>
  ({ g: 0, from, to, pos: [x, y], r: 18, dmg, angle, bkb: 30, kbg: 76, sfx: 'spark', fx: 'swoosh' });
...
const moves: Record<string, MoveDef> = {
  ...
  ftilt: {
    id: 'ftilt', total: 24,
    hitboxes: [{ g: 0, from: 6, to: 9, at: 'footF', r: 16, dmg: 8, angle: 36, bkb: 28, kbg: 78, sfx: 'kick' }],
    anim: [{ f: 3, fF: [10, 36], lean: -4 }, { f: 6, fF: [60, 40], lean: -16 }],
  },
  utilt: {
    id: 'utilt', total: 24,
  ...
  fsmash: {
    ...
    hitboxes: [whip(12, 15, 50, 50, 11, 36), { ...whip(12, 15, 86, 50, 15, 36), kbg: 94 }],
    anim: [{ f: 6, hF: [-20, 70], lean: -14 }, { f: 12, hF: [56, 56], lean: 16 }, { f: 16, hF: [52, 50], lean: 16 }],
  },
  usmash: {
    id: 'usmash', total: 44, charge: { frame: 8, smash: true },
    hitboxes: [
      { g: 0, from: 10, to: 20, pos: [0, 80], r: 26, dmg: 3, angle: 90, bkb: 20, kbg: 20, fixed: 40, sfx: 'spark' },
      { g: 1, from: 21, to: 24, pos: [0, 110], r: 30, dmg: 8, angle: 90, bkb: 40, kbg: 90, sfx: 'spark' },
    ],
  ...
  dsmash: {
    ...
    hitboxes: [
      { g: 0, from: 11, to: 14, pos: [52, 10], r: 22, dmg: 12, angle: 25, bkb: 32, kbg: 86, away: true, sfx: 'spark' },
      { g: 0, from: 11, to: 14, pos: [-52, 10], r: 22, dmg: 12, angle: 25, bkb: 32, kbg: 86, away: true, sfx: 'spark' },
    ],
  ...
  fair: {
    ...
    hitboxes: [whip(7, 10, 44, 52, 9, 40), { ...whip(7, 10, 76, 50, 11, 40) }],
    anim: [{ f: 3, hF: [0, 80], lean: -8 }, { f: 7, hF: [50, 56], lean: 12 }],
  },
  bair: {
  ...
  uair: {
    ...
    hitboxes: [{ g: 0, from: 5, to: 9, pos: [0, 108], r: 22, dmg: 8, angle: 88, bkb: 28, kbg: 80, sfx: 'spark' }],
    anim: [{ f: 2, hF: [10, 70] }, { f: 5, hF: [0, 100], hB: [-10, 96] }],
  },
  dair: {
    id: 'dair', total: 38, air: true, landingLag: 14,
    hitboxes: [{ g: 0, from: 9, to: 12, at: 'footF', r: 17, dmg: 11, angle: 270, bkb: 24, kbg: 72, sfx: 'kick' }],
    anim: [{ f: 5, fF: [10, 20] }, { f: 9, fF: [6, -16], fB: [-10, 10] }],
  },
  nspecial: {
    id: 'nspecial', total: 40, iasa: 32,
    projectiles: [{
      frame: 13, kind: 'bubble', at: 'handF', vx: 4.2, vy: -0.6, gravity: -0.012, life: 110, r: 17, reflectable: true,
      hit: { dmg: 8, angle: 55, bkb: 42, kbg: 50, sfx: 'spark' },
    }],
    hitboxes: [],
  ...
  uspecial: {
    ...
    hitboxes: [
      { g: 0, from: 5, to: 18, at: 'center', off: [0, -10], r: 26, dmg: 2, angle: 90, bkb: 20, kbg: 10, fixed: 50, sfx: 'spark' },
      { g: 1, from: 20, to: 23, at: 'head', r: 24, dmg: 5, angle: 80, bkb: 40, kbg: 70, sfx: 'spark' },
    ],
  ...
  dspecial: {
    ...
    hitboxes: [{ g: 0, from: 4, to: 6, at: 'center', r: 34, dmg: 4, angle: 70, bkb: 50, kbg: 20, sfx: 'spark' }],
